...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic21oYXJnbiIsImEiOiJjbTdubHN0emEwMmsyMm1zYm1iZHRjbmduIn0.8DULCsaBhd8GALweVe2sVg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/smhargn/cm7nm35df002i01s8be059sy7',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popıp
...
var stripe = Stripe('pk_test_51QyeVW4SyAZMyrsqkMKXhd9LvSPm2rH7boITA8EtlWmCXWarIqDO6ymYm324X7Ausl6tYMVQr6BvpOwyryStpBvC00yT5fVff4');
...
if (logOutBtn) {
  logOutBtn.addEventListener('click', function (e) {
    e.preventDefault(); //console.log('logOutBtn clicked');
